  ...
  data() {
    ...
    return {
      ...
      titleList: [ // 这里是静态数据的数组
        { id: 1, label: '签约日期',value:'project_abbreviation'},
        { id: 2, label: '签约单位',value:'owner'},
        { id: 3, label: '展台面积1',value:'booth_area1'},
        { id: 4, label: '合同金额1',value:'contract_amount1'},
        { id: 5, label: '到款金额',value:'received_amount'},
        { id: 6, label: '未付金额',value:'unpaid_amount'},

        { id: 7, label: '销售费用',value:'salesman'},
        { id: 8, label: '特装管理费',value:'special_decoration_management_fee'},
        { id: 9, label: '主体结构供应商',value:'main_structure'},
        { id: 10, label: '主体结构金额',value:'main_structure'},

        { id: 11, label: '加班费',value:'project_full_name'},
        { id: 12, label: '其他项目金额',value:'city'},

        { id: 13, label: '业务员',value:'exhibition_start_date'},
        { id: 14, label: '会展业务员',value:'exhibition_end_date'},
        { id: 15, label: '所属展会',value:'exhibition'},


        { id: 16, label: '合同状态',value:'unpaid_amount'},
