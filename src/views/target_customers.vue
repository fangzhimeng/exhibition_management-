...
export default {
  data() {
    return {
      //数据List
      dataList: [{creation_time: '张三', target_customers: 20,  business_opportunity_stage: '男', estimated_deal_time: '男', city: '男', customer_requirements: '男', exhibition_end_date: '男'
      ...
      titleList: [ // 这里是静态数据的数组
        ...
        { id: 2, label: '目标客户',value:'target_customers'},
        { id: 3, label: '商机阶段',value:'business_opportunity_stage'},
        { id: 12, label: '展台面积',value:'booth_area'},
        { id: 4, label: '预计成交时间',value:'estimated_deal_time'},
        { id: 5, label: '预计成交金额',value:'estimated_deal_amount'},
        { id: 6, label: '客户要求',value:'customer_requirements'},
        { id: 7, label: '目标备注',value:'exhibition_end_date'},
        { id: 8, label: '业务员',value:'contract_amount'},


        { id: 9, label: '指定设计师',value:'unpaid_amount'},
        { id: 10, label: '展位号',value:'received_amount'},
        { id: 16, label: '主办业务员',value:'total_cost1'},
        { id: 16, label: '所有者',value:'total_cost2'},
        { id: 11, label: '公司',value:'company'},
        { id: 12, label: '联系人',value:'booth_area1'},
        { id: 13, label: '目标名称',value:'contract_amount1'},
        { id: 24, label: '允许删改',value:'allow_deletion_modification'},
        { id: 25, label: '允许查找',value:'allow_search'},
        { id: 14, label: '金额',value:'orders_number'},
        { id: 15, label: '总面积',value:'orders_number1'},
        { id: 4,  label: '光地总面积',value:'light_ground_total_area'},
        { id: 16, label: '标摊总面积',value:'total_cost'},

        { id: 17, label: '状态',value:'gross_profit'},
        { id: 30, label: '更新时间',value:'update_time'},
        { id: 28, label: '创建者',value:'creator'},
        { id: 29, label: '修改者',value:'Modifier'},
        { id: 26, label: '编号',value:'number'},
        { id: 2, label: '所属展会',value:'exhibition'},
  ...
  data2() {
    return {
      ...
      titleList2: [ // 这里是静态数据的数组
        ...
        { id: 2, label: '所有者',value:'target_customers' },
        { id: 3, label: '商机阶段',value:'business_opportunity_stage'},
        { id: 4, label: '预计成交时间',value:'estimated_deal_time'},
        { id: 5, label: '预计成交金额',value:'city'},
        { id: 6, label: '客户要求',value:'customer_requirements'},
        { id: 7, label: '目标备注',value:'exhibition_end_date'},
        { id: 8, label: '业务员',value:'contract_amount'},
